...
public class ResourceUtils {
     ...
     */
    @Nullable
    public static String geFileFromAssets(@Nullable Context context, @NonNull String fileName) {
     ...
     */
    @Nullable
    public static String geFileFromRaw(@Nullable Context context, int resId) {
        if (context == null) {
            return null;
        }
     ...
     */
    @Nullable
    public static List<String> geFileToListFromAssets(@Nullable Context context, @NonNull String fileName) {
        if (context == null || TextUtils.isEmpty(fileName)) {
            return null;
        }
     ...
     */
    @Nullable
    public static List<String> geFileToListFromRaw(@Nullable Context context, int resId) {
        if (context == null) {
            return null;
        }
