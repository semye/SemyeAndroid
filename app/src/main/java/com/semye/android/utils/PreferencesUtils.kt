...
class PreferencesUtils private constructor() {
    companion object {
        var PREFERENCE_NAME = "Ruiwen"

        /**
         * @param context
         * @param key     The name of the preference to check exist
         */
        fun checkExist(context: Context, key: String?): Boolean {
         ...
         */
        fun revomeKey(context: Context, key: String?) {
            val settings = context.getSharedPreferences(
                PREFERENCE_NAME, Context.MODE_PRIVATE
            )
